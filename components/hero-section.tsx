...
import { ArrowRight, Menu, NotebookPen, Rocket, X } from 'lucide-react'
                    ...
                    <div className="relative py-24 lg:py-28">
                        <div className="mx-auto max-w-7xl px-6 md:px-12">
                            <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
                                ...
                                <p className="mx-auto mt-8 hidden max-w-2xl text-wrap text-lg sm:block">Capture thoughts instantly, organize with ease, and never lose track of what matters most.</p>
                                <p className="mx-auto mt-6 max-w-2xl text-wrap sm:hidden">Whether it’s a quick reminder, a to-do list, or your next big idea, keep everything safe and easy to find.</p>
                                ...
                                <div className="mt-8">
                                    <Button
                                        ...
                                        asChild>
                                        <Link href="#">
                                            <NotebookPen className="relative size-4" />
                                ...
                                <Swiper
                                    ...
                                    <SwiperSlide className="px-2">
                                        <div className="bg-background rounded-(--radius) h-44 max-w-lg border p-9">
                                            ...
                                            <p className="mt-6 text-center text-lg font-medium">Fire self hosting 💕</p>
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide className="px-2">
                                        <div className="bg-background rounded-(--radius) h-44 max-w-lg border p-9">
...
const CoolifyLogo = () => {
    const primaryStyle = { fill: '#2563eb', opacity: 0.18 };
    const layerStyle = { fill: '#2563eb', opacity: 0.18 };
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 460 160">


            <rect style={primaryStyle} x="52" y="52" width="152" height="40" rx="12" ry="12" />
            <rect style={layerStyle} x="52" y="164" width="152" height="40" rx="12" ry="12" />
            <rect style={layerStyle} x="32" y="72" width="40" height="112" rx="12" ry="12" />

            <rect style={primaryStyle} x="44" y="60" width="40" height="136" rx="12" ry="12" />
            <rect style={primaryStyle} x="72" y="44" width="152" height="40" rx="12" ry="12" />
            <rect style={primaryStyle} x="72" y="172" width="152" height="40" rx="12" ry="12" />
        </svg>
    )
}
